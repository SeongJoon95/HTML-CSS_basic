...
variable = '1,000,000,000,000,000,000,000,000,000,000,000,000'
console.log(typeof variable)
...
/*
    ...
    - 함수 레벨 스코프 : 함수 내에서 선언된 변수는 함수 안에서 사용 가능하고 함수 밖에선 사용 불가능
...
/*
    ...
    - 이런 문제를 해결하지 위해 ES6+에서는 var 사용을 지양하고 let, const 사용을 권장
*/
// console.log(y)
let y = 99;
if (true) {
